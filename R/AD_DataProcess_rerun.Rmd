...
pdf(file = "May27_cell_type_density.pdf", width = 24,height = 12)
...
pdf(file = paste0("Jun08_Fig7_cell_type_density_",j,".pdf"), width = 20,height = 10)
ggarrange(plotlist = plot_list,ncol = 3, nrow = 2) %>% print()
dev.off()
...
#Draw Figures
source("~/Desktop/At_Broad/AD/RScript/AD_Pseudo-timeFunction.R")
...
setwd("/Users/zhouhaowen/Desktop/At_Broad/AD/Mar02_rerun")
...
#Export xlsx
for(i in names(tmp_cell_type_list)){
  tmp_vec <- expr_df[["p_val_A"]] < p_val & expr_df[["p_val_B"]] < p_val & 
    expr_df[["max_int_A"]] == expr_df[["max_int_B"]]  & expr_df$group == i
  tmp_df <- expr_df[tmp_vec, c(1,23,9:22)]
  write.xlsx(tmp_df, file="Apr01_SDEG.xlsx", sheetName=paste0(i,"_13mo"), append = T, row.names=FALSE)
}
plot_list <- list()
